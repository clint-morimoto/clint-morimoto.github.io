...
<br/>
<br/>
Pictured above is the implementation of a dialogue system for Unity that I purchased on the Unity Asset store.  I wanted to code the entire game myself without the use of supplementary packages to support the game design, but after mulling it over I now think there are multiple benefits to trying to use a pre-designed Unity package with my project.
